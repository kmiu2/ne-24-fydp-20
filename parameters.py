mohtat2020 = {
    ...
    "Bulk solvent concentration [mol.m-3]": 7025.0,
    ...
    "EC initial concentration in electrolyte [mol.m-3]": 10.0,
    ...
    "Initial concentration in negative electrode [mol.m-3]": 48.0,
    "Initial concentration in positive electrode [mol.m-3]": 10052.0,
    ...
    "Lithium metal partial molar volume [m3.mol-1]": 2.4e-5,
    "Lithium plating transfer coefficient": 0.7,
    "Lower voltage cut-off [V]": 1.5,
    "Maximum concentration in negative electrode [mol.m-3]": 42000.0,
    "Maximum concentration in positive electrode [mol.m-3]": 10200.0,
    "Negative current collector conductivity [S.m-1]": 35500000.0,  # Al foil
    "Negative current collector density [kg.m-3]": 2710.0,
    "Negative current collector specific heat capacity [J.kg-1.K-1]": 890.0,
    "Negative current collector surface heat transfer coefficient [W.m-2.K-1]": 0.0,
    "Negative current collector thermal conductivity [W.m-1.K-1]": 205.0,
    "Negative current collector thickness [m]": 1.6e-5,
    ...
    "Negative electrode thermal conductivity [W.m-1.K-1]": 2.1,
    "Negative electrode thickness [m]": 0.41e-3,
    ...
    "Positive current collector thickness [m]": 2.2e-5,
    "Positive electrode Bruggeman coefficient (electrode)": 1.5,
    "Positive electrode Bruggeman coefficient (electrolyte)": 1.5,
    "Positive electrode active material volume fraction": 0.95,
    "Positive electrode charge transfer coefficient": 0.5,
    "Positive electrode conductivity [S.m-1]": 1000.0,
    "Positive electrode density [kg.m-3]": 1830.0,
    "Positive electrode double-layer capacity [F.m-2]": 0.2,
    "Positive electrode porosity": 0.3,
    "Positive electrode reaction-driven LAM factor [m3.mol-1]": 0.0,
    "Positive electrode reference exchange-current density [A.m-2(m3.mol)1.5]": 4.824e-06,
    "Positive electrode specific heat capacity [J.kg-1.K-1]": 300.0,
    "Positive electrode thermal conductivity [W.m-1.K-1]": 0.3,
    "Positive electrode thickness [m]": 1.62e-3,
    ...
    "Typical lithium ion diffusivity [m2.s-1]": 5.34e-11,  # Within the range of 10^-10 to 10^-12 (For both Li and Na)
