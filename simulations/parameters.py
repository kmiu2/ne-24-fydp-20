mohtat2020 = {
    ...
    "Negative electrode thickness [m]": 0.5e-3,
    ...
    "Positive current collector specific heat capacity [J.kg-1.K-1]": 890.0,
    "Positive current collector surface heat transfer coefficient [W.m-2.K-1]": 0.0,
    "Positive current collector thermal conductivity [W.m-1.K-1]": 205.0,
